...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, FLASH_WP_Pin|OLED_RST_Pin|OLED_DC_Pin|USB_HOST_PWR_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, TR_OUT_B_Pin|TR_OUT_A_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, CS_CS_Pin|CS_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : FLASH_WP_Pin OLED_RST_Pin OLED_DC_Pin USB_HOST_PWR_EN_Pin */
  GPIO_InitStruct.Pin = FLASH_WP_Pin|OLED_RST_Pin|OLED_DC_Pin|USB_HOST_PWR_EN_Pin;
  ...
  /*Configure GPIO pins : PD11 PD12 PD13 PD5
                           PD7 */
  ...
  /*Configure GPIO pins : SW_A_Pin TR_IN_A_Pin SW_B_Pin */
  GPIO_InitStruct.Pin = SW_A_Pin|TR_IN_A_Pin|SW_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : TR_IN_B_Pin */
  GPIO_InitStruct.Pin = TR_IN_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(TR_IN_B_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : TR_OUT_B_Pin TR_OUT_A_Pin */
  GPIO_InitStruct.Pin = TR_OUT_B_Pin|TR_OUT_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
