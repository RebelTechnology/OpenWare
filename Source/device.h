...
#define FIRMWARE_VERSION "v22.5.rc4"
...
#define MAX_SYSEX_FIRMWARE_SIZE                                                \
  ((16 + 16 + 64 + 128 + 128) * 1024) // FLASH sectors 2-6
#endif
#ifndef MAX_SYSEX_BOOTLOADER_SIZE
#define MAX_SYSEX_BOOTLOADER_SIZE                                              \
  (64 * 1024) // OWL1 uses 32kb, must be overridden
#endif
...
#define AUDIO_BLOCK_SIZE                                                       \
  32 /* default size in samples of a single channel audio block */
#endif
...
#define ARM_CYCLES_PER_SAMPLE                                                  \
  (168000000 / AUDIO_SAMPLINGRATE) /* 168MHz / 48kHz */
#endif
