...
int main(void)
{
  ...
  const osThreadAttr_t defaultTask_attributes = {
    ...
    .cb_mem = NULL,
    .cb_size = sizeof(NULL),
    .priority = (osPriority_t) 128,
  };
  defaultTaskHandle = osThreadNew(defaultTask1, NULL, &defaultTask_attributes);
...
static void MX_SAI1_Init(void)
{
  ...
  hsai_BlockA1.SlotInit.SlotNumber = 10;
  ...
  hsai_BlockB1.SlotInit.SlotNumber = 10;
...
__weak void defaultTask1(void *argument)
{
