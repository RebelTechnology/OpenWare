...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void defaultTask1(void *argument);
/* USER CODE END 0 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : EXTI5_Pin EXTI7_Pin */
  GPIO_InitStruct.Pin = EXTI5_Pin|EXTI7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : PC15 PC0 PC1 ADC6_Pin 
                           ADC2_Pin PC7 PC8 PC9 
                           PC10 PC11 PC12 */
  GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_0|GPIO_PIN_1|ADC6_Pin 
                          |ADC2_Pin|GPIO_PIN_7|GPIO_PIN_8|GPIO_PIN_9 
  ...
  /*Configure GPIO pins : PA0 PA1 PA2 PA3 
                           PA4 PA5 ADC8_Pin ADC4_Pin 
                           PA8 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3 
                          |GPIO_PIN_4|GPIO_PIN_5|ADC8_Pin|ADC4_Pin 
  ...
  /*Configure GPIO pin : USBH_ID_Pin */
  GPIO_InitStruct.Pin = USBH_ID_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF12_OTG_HS_FS;
  HAL_GPIO_Init(USBH_ID_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : EXTI4_Pin EXTI8_Pin EXTI3_Pin EXTI2_Pin 
                           EXTI6_Pin */
  GPIO_InitStruct.Pin = EXTI4_Pin|EXTI8_Pin|EXTI3_Pin|EXTI2_Pin 
                          |EXTI6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : EXTI1_Pin */
